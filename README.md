...
## Decisions
I made several technical decisions during this implementation. The first one is what frameworks should be uses. 
I created a Java SpringBoot as I am used to work with springboot and creating a REST api is a usual case in spring. 
Reactive libraries (webflux, r2dbc) were included in order to achieve the goals on performance. 
It is easy to overload the application when loading in memory all the data. With reactive code we stream the data and also the threads created are reused.
It took me some time to get used to reactive coding as I am still learning but I am happy with the result and I also have learned a lot.
